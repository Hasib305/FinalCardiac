...
public class MainActivity extends AppCompatActivity implements UserRVAdapter.UserClickInterface {
    ...
    private void displayBottomSheet(UserRVModal modal) {
        ...
        userNameEdt.setText(modal.getUserName());
        cmnt.setText(modal.getUserDesc());
        systolic.setText(modal.getUsersys());
        diostolic.setText(modal.getUserdio());
        heart.setText(modal.getUserheart());
